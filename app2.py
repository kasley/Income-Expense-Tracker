...
import firestore_db as db  # Firestore import

# -------------- SETTINGS --------------
incomes = ['Salary', 'Block Account', 'Other Income']
expenses = ['Rent', 'Health Insurance', 'Utilities', 'Groceries', 'Other Expenses', 'Savings']
currency = "EUR €"
